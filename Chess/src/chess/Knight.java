...
public class Knight extends ChessPiece {
    ...
    public Knight(Location l, int color, int ID) {
        super.pieceID = ID;
        ...
        super.pieceType = Constants.KNIGHT;
    }
    ...
    public boolean validateMove(Location destinationPosition) {
        ...
        if (((pLoc.getY() == destinationPosition.getY() - 1) || (pLoc.getY() == destinationPosition.getY()+ 1)) && ((pLoc.getX() == destinationPosition.getX() + 2) || (pLoc.getX() == destinationPosition.getX() - 2))) {
            canmove = true;
        }
        if (((pLoc.getY() == destinationPosition.getY() - 2) || (pLoc.getY() == destinationPosition.getY()+ 2)) && ((pLoc.getX() == destinationPosition.getX() + 1) || (pLoc.getX() == destinationPosition.getX() - 1))) {
            canmove = true;
        }
    ...
    public boolean hasCheckOnOpposingKing(Location positionOfOpposingKing) {
        ...
        if (((pLoc.getY() == positionOfOpposingKing.getY() - 1) || (pLoc.getY() == positionOfOpposingKing.getY()+ 1)) && ((pLoc.getX() == positionOfOpposingKing.getX() + 2) || (pLoc.getX() == positionOfOpposingKing.getX() - 2))) {
            checked = true;
        }
        if (((pLoc.getY() == positionOfOpposingKing.getY() - 2) || (pLoc.getY() == positionOfOpposingKing.getY()+ 2)) && ((pLoc.getX() == positionOfOpposingKing.getX() + 1) || (pLoc.getX() == positionOfOpposingKing.getX() - 1))) {
            checked = true;
        }
        return checked;
    }
